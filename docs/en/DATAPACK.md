...
**➜ `gimmicks` is covered in [GIMMICKS.md](GIMMICKS.md)**: the stone, the Z-Crystal and the Tera
type to hand the Pokémon, when the trainer uses them, and what has to be installed for each.
