...
object CobblemonTrainers {
    ...
    fun onInitialize() {
        Platform.current.registerCommands { dispatcher ->
        ...
        Platform.current.registerReloadListener(PackType.SERVER_DATA, id(DATAPACK_ROOT), TrainerReloadListener::onResourceManagerReload)
    ...
    private object TrainerReloadListener {
